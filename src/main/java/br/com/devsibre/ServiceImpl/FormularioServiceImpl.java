...
//lista parentesco - busca todos os cadastros
	...
	public List<FormularioModel> listarApenasMembros() {
		return formularioRepo.findByMembroTrue();
	}

	public List<FormularioModel> listarApenasNaoMembros() {
	...
	@Override
	public SaveOrUpdateResponse saveOrUpdate(FormularioModel cm) {
		// Verifique se já existe um cadastro com o mesmo número de telefone
		FormularioModel existingCadastro = formularioRepo.findByFone(cm.getFone());
