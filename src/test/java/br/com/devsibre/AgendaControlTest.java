...
class AgendaControlTest {
    ...
    void testGetAgenda() throws Exception {
        ...
        agendas.add(new AgendaModel(1L, "Agenda 1", null, LocalDate.now(), null));
        agendas.add(new AgendaModel(2L, "Agenda 2", null, LocalDate.now(), null));
    ...
    void testGetAgendaDetails() throws Exception {
        long agendaId = 1L;
        AgendaModel agenda = new AgendaModel(agendaId, "Agenda 1", null, LocalDate.now(), null);
